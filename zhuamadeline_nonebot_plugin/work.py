...
async def work_help_handle(bot: Bot, Bot_event: GroupMessageEvent):
    msg = (
        "以下是关于工作的一些指令：\n\n"
        ".work 工作区域/携带食物/派遣madeline的名称\n工作的主命令，派遣madeline出去工作，不过注意派出去的madeline不会回来哦！\n携带的食物和体力可以在商店里面购买，体力也可以通过休息来恢复，工作区域在下面有哦！\n\n"
        ...
        "smots-8: 随机数量的草莓、急救包、一次性小手枪、充能陷阱、道具盲盒、胡萝卜、madeline提取器、时间秒表、海星、水母、胖头鱼、\n胖头鱼罐头、水晶胖头鱼、星鱼")
