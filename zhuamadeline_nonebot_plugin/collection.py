...
collections = {
    ...
    '时隙沙漏': [
        ...
        8, 
        5, 
        '这是抓玛德琳世界中的十大秘宝之一。一个由神秘的蓝色水晶制成的神秘沙漏，但是却散发着淡金色光芒。沙漏的沙粒中闪烁着时间的碎片，当沙漏翻转时，持有者能暂时打破时间的桎梏——那些未被使用的等待时间将化作"时之砂"储存起来。这个沙漏似乎能将你未使用的等待时间储存为抓取机会，不过似乎……这种力量无法于竞技场中使用。' #每29/30分钟(受回想之核影响)自动积累1次抓取机会，最多可储存10次机会，使用时不会触发冷却时间
    ],
    '逆十字架': [
        100000,
        8, 
