...
collections = {
    ...
    [
        ...
        7,
        4,
        '这是抓玛德琳世界中的十大秘宝之一。它承载了时间的记忆与无尽的价值，尘封的秘宝是智慧与奇迹的结晶，在抓madeline可以获得草莓的情况下，每次抓到madeline时将额外获得少量草莓。'#加2草莓
    ],
    '奇想魔盒':
    [
        30000,
    ...
    [
        ...
        '现在草莓果园可用指令：.garden 收菜(take)/施肥(fert)/偷菜(steal)/播种(seed)\n\n'
    ...
    [
        ...
        7,
        5,
        '这是抓玛德琳世界中的十大秘宝之首。一颗由坠落的星辰核心凝练而成的宝石，表面流淌着银河般的微光。当星钻的光芒照耀时，持有者将获得"星光护佑"——柔和的星辉能驱散疲惫，让身心重获活力。' #5%概率直接清除冷却
    ],
}