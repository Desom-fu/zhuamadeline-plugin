...
async def cklc_handle(arg: Message = CommandArg()):
    ...
    LC_INFO = {
        0: '''madeline竞技场
· 危险等级：PVP！！！
· 描述：坐落在塞莱斯特山脚小镇中心的圆形竞技场，由小镇镇长Desom-fu建造。场地采用特殊的反重力技术，悬浮平台会随着比赛进程随机重组。这里每天都会举办"玛德琳擂台赛"，参赛者可以使用自己捕捉的玛德琳进行对战！竞技场外围常年聚集着贩卖能量饮料和稀有道具的商贩，空气中总是弥漫着兴奋的呐喊声和电子记分牌的嗡嗡声。
· 准入需求：在古代遗迹中抓到过30个1+2级、4个4级、1个1级玛德琳''',
...
· 准入需求：持有5片神秘碎片；前三个猎场持有的5级玛德琳种类加起来超过9种''',
...
· 准入需求：持有50000点能量（消耗，一次性）；满足前3个猎场的玛德琳竞技场的准入需求；残片、音矿、安定之音的持有总价值超过15000草莓''',
