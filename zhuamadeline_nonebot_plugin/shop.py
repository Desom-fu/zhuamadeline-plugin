#禁止回收道具
forbid_recycle_item = {"道具盲盒","烂胡萝卜","复仇之刃","招财猫","指南针","神秘碎片","幸运药水","赌徒之眼","音矿","残片","神权模拟器","草莓果酱","安定之音","体力"}
...
# 开放猎场类道具
    ...
    [
        75,
        5,
        '香甜的热带水果，能快速补充能量。带上此食物时，工作有5%概率额外获得1-20颗草莓'
    ],
    '杨桃':
    [
        650,
        5,
        '精致的星形果实，象征着好运。带上此食物时，触发高薪工作的概率提升10%'
    ],
    '百香果':
    [
        700,
        5,
        '珍稀的芳香果实，能激发工作潜能。带上此食物时，每小时必定增加一次额外工作机会'
    ],
}
